...
const Intro = () => {
  ...
  return (
<div id="services" className="relative bg-gradient-to-b from-white to-blue-50 dark:bg-gradient-to-b dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 py-16">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-6">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-300 dark:to-blue-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div
              ...
              className={`group bg-white/80 dark:bg-gray-800 backdrop-blur-sm p-6 rounded-xl shadow-sm dark:shadow-gray-700/30 border-l-4 ${service.borderColor} hover:shadow-2xl hover:-translate-y-2 hover:scale-105 hover:z-10 transition-all duration-300 cursor-pointer h-full flex flex-col`}
            >
              <div className="flex flex-col items-start">
                <div className="mb-6 p-3 bg-gray-50 dark:bg-gray-700 rounded-full transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
                  {service.icon}
                </div>
